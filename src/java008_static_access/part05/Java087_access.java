 ...
 * modifier 제어자
 * 클래스 - public
 * 변수 - public, private, protected, default(아무것도 없음) 
 ...
 *  
 * 1. private : 정의된 같은 클래스에서만 접근이 가능하다.
 * 2. default : 같은 패키지에서만 접근이 가능하다.
 * 3. protected : 같은 패키지내에서만, 그리고 다른 패키지의 자손 클래스에서만 접근이 가능하다.
 * 4. public : 접근 제한이 없다.
 * 
 * 접근제어자 사용
 *  class : default, public 만 사용가능
 *  variable, method, constructor : private, default, protected, public 모두사용가능
 *  
 * 접근제어자 범위
