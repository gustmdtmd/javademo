...
public class Java125_RegEx {
	...
	public static void main(String[] args) {
		...
		//a-zA-Z_*$가 sn변수에 포함이 되어 있으면 true 아니며 false를 리턴한다.
		...
		//st변수에 저장된 값이 a이거나 b로 시작하고 임의 문자가 5개이면 true 아니면 false를 리턴한다.
		System.out.println(st.matches("[ab].{5}"));
		
		//st변수에 저장된 값이 a이거나 b로 시작하고 임의 문자가 1~5개이며 cc로 끝나면 true 아니면 false를 리턴한다.
		st = "aetwefcc";
